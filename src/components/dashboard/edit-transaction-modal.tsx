...
import { updateTransaction } from "@/app/dashboard/transacciones/actions"
            ...
            <DialogContent className="sm:max-w-[425px]">
                <form action={handleSubmit}>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Modifica los detalles de la transacción. Haz clic en guardar cuando termines.
                        </DialogDescription>
                    </DialogHeader>
                    <div className="grid gap-4 py-4">
                        ...
                        <div className="grid grid-cols-4 items-center gap-4">
                            ...
                            <div className="col-span-3">
                                <Select name="type" required defaultValue={transaction.type === "ingreso" || transaction.type === "Ingreso" ? "Ingreso" : "Gasto"}>
                                    <SelectTrigger>
